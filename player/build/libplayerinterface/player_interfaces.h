...
The @p sonar interface returns readings from a robot's sonars. */
...
@ref PLAYER_BUMPER_REQ_GET_GEOM request.  The response will be in this form.  This
...
To request robot geometry, send a null @ref PLAYER_POSITION3D_REQ_GET_GEOM request. */
...
To change control mode, send a @ref PLAYER_POSITION3D_REQ_POSITION_MODE request.
Null response.
*/
...
Some robots offer different velocity control modes.  It can be changed by
sending a @ref PLAYER_POSITION3D_REQ_VELOCITY_MODE request with the format given
...
To set the robot's odometry to a particular state, send a
@ref PLAYER_POSITION3D_REQ_SET_ODOM request.  Null response. */
...
send a @ref PLAYER_POSITION3D_REQ_RESET_ODOM request.  Null response. */

/** @brief Request/reply: Set velocity PID parameters.
 *
 * To set velocity PID parameters, send a @ref PLAYER_POSITION3D_REQ_SPEED_PID
 * request.  Null response. */
...
/** @brief Request/reply: Set position PID parameters.
 *
 * To set position PID parameters, send a @ref PLAYER_POSITION3D_REQ_POSITION_PID
 * request.  Null response. */
 ...
 *
 * To set speed profile parameters, send a @ref PLAYER_POSITION3D_REQ_SPEED_PROF
 * request.  Null response. */
...
To retrieve an property of an object in a simulator, send a @ref
...
To set a property, send a completely filled in @ref
...
/** @ingroup message_codes
 * @{ */
#define PLAYER_COOPOBJECT_CODE 66
/** @} 
 *  @ingroup message_strings
 * @{ */
#define PLAYER_COOPOBJECT_STRING "coopobject" 
/** @} */
// /////////////////////////////////////////////////////////////////////////////
/** @ingroup interfaces
  @defgroup interface_coopobject coopobject
